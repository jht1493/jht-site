  1.mobileworks | breadfruit    .recentcomments a{display:inline !important;padding:0 !important;margin:0 !important;}
...
The aim is to leverage [mobileworks.com](https://www.mobileworks.com/) to  
– create an online documentary on Professor John Fray’s work using the mobileworks.com  
– provide sample code that mobile app competition participates can use for their projects.

[moibleworks dashboard zip download](http://j4u2.com/breadfruit-examples/-mw-dash.zip)[ ](https://www.mobileworks.com/)— translation of curl example code to HTML5

Issues:  
– mobileworks api does not appear to allow setting pricing  
– setting skills fails when sent to sand box. Did not try sending to production.

### Leave a Reply [Cancel reply](/breadfruit/mobileworks/#respond)
